                ...
                <div class="zone-box">
                    ...
                    <div class="stall-grid">
                        @foreach ($stalls->where('zone_id', $zoneId) as $stall)
                            ...
                            <form action="{{ route('admin.stalls.toggle', [$stall->stall_id, $month, $year]) }}"
                                method="GET">
                                <button type="submit" class="stall-btn {{ $statusClass }}"
